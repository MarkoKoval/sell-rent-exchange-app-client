...
-->
                    ...
                    <div class="d-flex justify-content-end">
                          ...
                          <a v-if="proposal.answered !== null" target="_blank" :href="'/show/request/answer/'+ proposal.proposal.answered"
                           class="btn-sm btn-primary" style="margin-right: 5px;  margin-left: 5px; margin-top:5px;">Відповісти</a>

                           <a v-else target="_blank" :href="'/answer/request/'+ proposal.id"
                           class="btn-sm btn-primary" style="margin-right: 5px;  margin-left: 5px; margin-top:5px;">Відповісти</a>
                        ...
                        <a target="_blank" :href="'/proposals/request/'+ proposal.id +'/details/'"
                         ...
                         <a target="_blank" :href="'/proposals/'+ proposal.requested_main_item +'/details/'"
                               class="btn-sm btn-primary" style="margin-right: 5px;  margin-left: 5px; margin-top:5px;">Основний бажаний обєкт</a>
        ...
        methods: {
            ...
            load_my_requests(self) {
             ...
             //   var self = this;
                $.get({
                    async: true,
                    url:/* "http://127.0.0.1:8000"*/ current_host + "/get/requests/to_me/" + self.auth_id,
