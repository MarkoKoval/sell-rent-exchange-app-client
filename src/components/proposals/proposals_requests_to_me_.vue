                ...
                <div class="card w-75  containerq">
                    <div class="card-body ">
                       ...
                       <div class="d-flex justify-content-end">
                            <button v-on:click="delete_request(request.request_id)" class="btn-sm btn-success" style="margin-right: 5px;  margin-left: 5px;">Погодити</button>
                            <button v-on:click="delete_request(request.request_id)" class="btn-sm btn-primary" style="margin-right: 5px;  margin-left: 5px;">Зворотня пропозиція</button>
                            <button v-on:click="delete_request(request.request_id)" class="btn-sm btn-danger" style="margin-right: 5px;  margin-left: 5px;">Відхилити</button>
...
import edit_proposal from "./edit_proposal.vue"
    ...
    export default {
        name: "proposals_requests_to_me_",
